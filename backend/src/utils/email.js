      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9f9f9;">
          ...
          <p style="color: #666; font-size: 14px;">
            هذا الرابط صالح لمدة ${data.expiresIn} فقط. إذا لم تطلب إعادة تعيين كلمة المرور، يرجى تجاهل هذا البريد الإلكتروني.
          </p>
          <p style="color: #666; font-size: 14px;">
            This link is valid for ${data.expiresIn} only. If you didn't request a password reset, please ignore this email.
          </p>
        </div>
      </div>
    `
