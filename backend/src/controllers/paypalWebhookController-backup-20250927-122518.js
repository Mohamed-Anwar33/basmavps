 ...
 * Ø¹Ù†Ø¯Ù…Ø§ ÙŠØªÙ… Ø§Ù„ØªÙ‚Ø§Ø· Ø§Ù„Ø¯ÙØ¹Ø© Ø¨Ù†Ø¬Ø§Ø­ - Ø§Ù„Ø£Ù…Ø§Ù† Ø§Ù„Ø­Ù‚ÙŠÙ‚ÙŠ
 * Ù‡Ø°Ø§ Ø§Ù„Ø¥Ø´Ø¹Ø§Ø± ÙŠØ£ØªÙŠ Ù…Ù† PayPal Ù…Ø¨Ø§Ø´Ø±Ø© ÙˆÙ„Ø§ ÙŠÙ…ÙƒÙ† ØªØ²ÙˆÙŠØ±Ù‡
 */
const handlePaymentCaptured = async (payload) => {
  try {
    ...
    if (order && order.paymentStatus !== 'paid') {
      ...
      // Ø¥Ø±Ø³Ø§Ù„ Ø¥ÙŠÙ…ÙŠÙ„ Ø§Ù„ØªØ£ÙƒÙŠØ¯ - ÙÙ‚Ø· Ø¨Ø¹Ø¯ Ø§Ù„ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ù„Ø¯ÙØ¹
      await sendOrderConfirmationEmail(order);
      
      // Ø¥Ø±Ø³Ø§Ù„ Ø±ÙˆØ§Ø¨Ø· Ø§Ù„ØªØ³Ù„ÙŠÙ… Ø§Ù„Ø±Ù‚Ù…ÙŠ Ø¥Ù† ÙˆØ¬Ø¯Øª
      await sendDigitalDeliveryLinks(order);
